...
MODEL_knn = os.path.join(settings.BASE_DIR, 'knn.pkl')
MODEL_naive = os.path.join(settings.BASE_DIR, 'naive.pkl')
MODEL_reg = os.path.join(settings.BASE_DIR, 'reg.pkl')
MODEL_svc = os.path.join(settings.BASE_DIR, 'svc.pkl')
MODEL_tree = os.path.join(settings.BASE_DIR, 'tree.pkl')
...
def predict(request):
    try:
        ...
        # LOAD MODEL
        # ---------------------------
        modelt = request.data.get('modeltype')
        print(modelt)
        if modelt == 'KNN':
            try:
        ...
        return Response({'prediction': rounded, "model": modelt})
